...
const tabsListVariants = cva(
  'group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none',
  {
    variants: {
      variant: {
        default: 'glass-panel rounded-xl border-[oklch(0.5_0.1_280_/_10%)] bg-muted',
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        'data-active:bg-background data-active:text-foreground data-[state=active]:bg-gradient-to-r data-[state=active]:from-[oklch(0.5_0.18_270_/_20%)] data-[state=active]:to-[oklch(0.5_0.15_300_/_15%)] data-[state=active]:gradient-text dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground',
