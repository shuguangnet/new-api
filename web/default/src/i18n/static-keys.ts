...
export const STATIC_I18N_KEYS = [
  ...
  'Look for concentration risk in high-volume models.',
  'Check whether latency and success metrics still support the current pricing posture.',
  'Use the detailed charts below to decide whether to rebalance traffic or refine delivery tiers.',
  'Analytics workspace',
  'Model delivery analytics board',
